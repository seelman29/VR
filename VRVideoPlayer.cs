...
namespace Evereal.VRVideoPlayer
{
  ...
  public class VRVideoPlayer : MonoBehaviour
  {
        #region Properties
        int Index = 1;
    string[] Vids = new string[2] {"Videos/21","Videos/23"};

        ControllerInput x = new ControllerInput();
    ...
    public GameObject UIObject;
        bool isPressed;
        static public bool looped = false;
        static public bool Videolooped = false;
    ...
    private IMediaPlayer mediaPlayer = new EMTMediaPlayer();
        ...
        public IMediaPlayer mediaPlayer = new UnityMediaPlayer();
